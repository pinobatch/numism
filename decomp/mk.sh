...
python3 ../gameboy/tools/vwfbuild.py tilesets/Fauxtura.png obj/gb/Fauxtura.asm
rgbasm -hL -p 0xFF -o obj/gb/Fauxtura.o obj/gb/Fauxtura.asm
python3 tools/extractcels.py tilesets/Mindy.ec tilesets/Mindy.png obj/gb/Mindy.2b obj/gb/Mindy.asm
...
rgblink -dt -p 0xFF -o level1.gb -n level1.sym \
  obj/gb/level1.o obj/gb/pads.o obj/gb/vwfdraw.o \
